...
export function TaskCard({ task, user, index, setUser }: TaskCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className='flex justify-end sm:w-full max-w-64 gap-4 overflow-hidden'>
        ...
        <FaAngleDown
          size={16}
          className='shrink-0 text-[#6F6F6F] hover:text-[#363636] transition-all duration-200 cursor-pointer'
        />
      </div>
    </div>
  );
